...
<link rel="stylesheet" type="text/css" href="/nyoba/css/common.css">  <link href="/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
                    ...
                    <div class="col-md-12" style="margin-bottom:30px">
                        <div class="card-body p-4">
                            ...
                            <input type="text" class="form-control" id="room_no" name="room_no" placeholder="col-form-label" value="{{ $room->no }} " disabled>
                             ...
                             placeholder="col-form-label" value="{{ $room->capacity }} " disabled>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                             ...
                             <input type="text" class="form-control" id="check_in" name="check_in"
                                 placeholder="col-form-label" value="{{ Carbon\Carbon::parse($stayfrom)->isoformat('D MMMM Y') }}" disabled>
                             ...
                             <input type="text" class="form-control" id="check_out" name="check_out"
                                 placeholder="col-form-label" value="{{ Carbon\Carbon::parse($stayuntil)->isoformat('D MMMM Y') }}" disabled>
