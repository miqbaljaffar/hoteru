...
@section('title') <title>DONQUIXOTE | KAMAR #{{$room->no}}</title>@endsection
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                @if ($room->images->count() > 0)
                    ...
                    <img src="{{asset('storage/' . $room_images->image)}}" class="image-swipper d-block" alt="{{$room_images->image}}">
                    @endforeach
                @else
    ...
    <div class="container py-5">
        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-6 col-lg-4 col-4 text-end">
                <h4 class="h-font room-price" ><span class="text-success fw-bold"> IDR {{ number_format($room->price)}}</span><span class="text-muted">/night
                        </span></h4>
