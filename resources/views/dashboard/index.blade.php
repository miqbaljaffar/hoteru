                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-2 font-weight-bold text-gray-800">{{ $persen }}%</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        ...
                                        <div class="progress-bar bg-info" role="progressbar"
                                            style="width: {{$kiri}}%" aria-valuenow="{{ $kiri }}" aria-valuemin="0"
                                            aria-valuemax="100"> @if ($persen > 100)
                                            100
                                            @endif
                                        </div>
                                            @if ($persen > 100)
                                            <div class="progress-bar bg-warning" role="progressbar"
                                            style="width: {{$kanan}}%" aria-valuenow="{{ $kanan }}" aria-valuemin="0"
                                            aria-valuemax="100">{{$persen - 100}}</div>
                                            @endif
