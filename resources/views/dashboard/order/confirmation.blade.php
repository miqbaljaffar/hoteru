...
<div class="card-body p-4">
  <div class="row">
   ...
   value="IDR {{ number_format($room->price) }}" readonly>
              </div>
          </div>
      </div>
      <hr>
   ...
   <input type="text" class="form-control" id="check_in" name="check_in"
       placeholder="col-form-label" value="{{ Carbon\Carbon::parse($stayfrom)->isoformat('D MMMM Y') }}" readonly>
                  </div>
              </div>
              <div class="row mb-3">
   ...
   <input type="text" class="form-control" id="check_out" name="check_out"
       placeholder="col-form-label" value="{{ Carbon\Carbon::parse($stayuntil)->isoformat('D MMMM Y') }}" readonly>
                  </div>
              </div>
              <div class="row mb-3">
