                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="check_in" name="check_in"
                                                            placeholder="col-form-label" value="{{ Carbon\Carbon::parse($transaction->check_in)->isoformat('D MMMM Y') }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="check_out" name="check_out"
                                                            placeholder="col-form-label" value="{{ Carbon\Carbon::parse($transaction->check_out)->isoformat('D MMMM Y') }}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="room_price" name="room_price"
                                                            ...
                                                            value="IDR {{ number_format($transaction->Room->price) }} "
                                                            readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" id="total_price" class="form-control"value="IDR {{ number_format($transaction->getTotalPrice($transaction->room->price, $transaction->check_in, $transaction->check_out)) }}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" id="Paidoff" class="form-control"value="IDR {{ number_format($transaction->getTotalPayment()) }}" readonly>
                                                    </div>
                                                </div>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="text-align: center; width:50px">
                                                    <span>
                                                        <i class="fas {{ $transaction->Customer->gender == 'Male' ? 'fa-male' : 'fa-female' }}">
                                                        </i>
                                                    </span>
                                                </td>
                                                <td>
